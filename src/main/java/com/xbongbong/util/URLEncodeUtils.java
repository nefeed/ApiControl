...
public class URLEncodeUtils {
	...
	public static void main(String[] args) {
		String url  = "he%E5%93%A6%E8%BE%85+%E5%AF%BC+%E8%B4%B9+%23+%25+++%EF%BF%A5h111";
		url=url.replaceAll("\\+", "%20");
		System.out.println(url);
		//System.out.println(URLEncodeUtils.encodeURL(url));
		String test="{  \"addTimeClient\" : \"1399728290\",";
		System.out.println(URLEncodeUtils.encodeURL(test));
	}
